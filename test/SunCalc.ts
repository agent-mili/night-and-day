...
describe('SunCalc', function () {
    xit('should return sun position', async function () {
        ...
        console.log(Number(sunPosition[0] / 10n ** 14n) * 180 / Math.PI/ 1e4, Number(sunPosition[1] / 10n ** 14n) * 180 / Math.PI/ 1e4 );
    ...
    it ('should return moon illumination', async function () {
